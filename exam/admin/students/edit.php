...
$id = $_GET['id'];
$qry = "SELECT * from user where id='$id' AND type='Student'";
    ...
    if (!empty($_POST['name'])) {
        if (!empty($_POST['email'])) {
            ...
            if ($result->num_rows < 1) {
                ...
                $qry = "UPDATE user SET name='$name', email='$email' $passwordQ WHERE id='$id' AND type='Student'";
...
<?php include "../header.php";?>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2 text-secondary"><span class="text-success">E</span>dit Student</h1>
    </div>
        ...
        <div class="px-4 py-2">
            <div class="row">
                <div class="col-12 col-lg-8 mx-auto">
                    <form method="POST">
                        <a href="<?php echo $url . 'admin/students.php'; ?>" class="btn backbutton w-25 rounded-pill">Back</a>
